    ...
    public static void addVillageCrops(final ServerAboutToStartEvent event) {
        ...
        if (Configuration.GENERATE_VILLAGE_FARM_FD_CROPS.get()) {
            ...
            StructureProcessor temperateCropProcessor = new RuleProcessor(List.of(
                    new ProcessorRule(new RandomBlockMatchTest(Blocks.BEETROOTS, 0.3F), AlwaysTrueTest.INSTANCE, HHModBlocks.GREEN_GRAPE_CROP.get().defaultBlockState()),
                    new ProcessorRule(new RandomBlockMatchTest(Blocks.WHEAT, 0.3F), AlwaysTrueTest.INSTANCE, HHModBlocks.RED_GRAPE_CROP.get().defaultBlockState()),
            ...
            StructureProcessor aridCropProcessor = new RuleProcessor(List.of(
                    new ProcessorRule(new RandomBlockMatchTest(Blocks.BEETROOTS, 0.3F), AlwaysTrueTest.INSTANCE, HHModBlocks.COTTON_CROP.get().defaultBlockState()),
                    new ProcessorRule(new RandomBlockMatchTest(Blocks.CARROTS, 0.3F), AlwaysTrueTest.INSTANCE, HHModBlocks.CORN_STALK.get().defaultBlockState()),
                    new ProcessorRule(new RandomBlockMatchTest(Blocks.WHEAT, 0.3F), AlwaysTrueTest.INSTANCE, HHModBlocks.PEANUT_CROP.get().defaultBlockState())
            ));
