...
public class HHModFluids {
    ...
    public static final RegistryObject<FluidType> BLUEBERRY_WINE_FLUID_TYPE = FLUID_TYPES.register("blueberry_wine_type", BlueberryWineFluidType::new);
    ...
    public static final RegistryObject<FluidType> CHERRY_WINE_FLUID_TYPE = FLUID_TYPES.register("cherry_wine_type", CherryWineFluidType::new);
    ...
    public static final RegistryObject<FluidType> GREEN_GRAPE_WINE_FLUID_TYPE = FLUID_TYPES.register("green_grape_wine_type", GreenGrapeWineFluidType::new);
    ...
    public static final RegistryObject<FluidType> RASPBERRY_WINE_FLUID_TYPE = FLUID_TYPES.register("raspberry_wine_type", RaspberryWineFluidType::new);
    ...
    public static final RegistryObject<FluidType> RED_GRAPE_WINE_FLUID_TYPE = FLUID_TYPES.register("red_grape_wine_type", RedGrapeWineFluidType::new);
