package alabaster.hearthandharvest.common.entity.crow;// Save this class in your mod and generate all required imports
...
public class CrowAnimations {
    ...
    public static final AnimationDefinition flying = AnimationDefinition.Builder.withLength(1.0025F).looping()
