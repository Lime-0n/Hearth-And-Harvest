...
public class CaskMenu extends AbstractContainerMenu {
    public final CaskBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public CaskMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public CaskMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CASK_MENU.get(), pContainerId);
        this.blockEntity = ((CaskBlockEntity) entity);
